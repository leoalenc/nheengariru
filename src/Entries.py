...
# TODO: Objects of the Example class should be defined outside individual entries in a separate module since individual examples are often used many times in different entries throughtout the dictionary
...
example5=Example("Mairamé mira urikú waá wirá akanga umaã teyú usasá suakí, uyeréu mira eté, umuatá mirapara, [...].", amorim, "Quando a pessoa que tinha cabeça de pássaro viu o lagarto passar perto dela, virou gente de verdade, entesou o arco, [...].")
example6=Example("Itakamutí pupé ne yasukawa, pitangé puranga ité.", baena, "Numa pia de pedra foi o teu batismo, ó menino muito bom.")
...
def ExampleEntry2():
	...
	sense_example1=SenseExample(example5,formlist)
	sense_example2=SenseExample(example6,formlist)
	sense1=Sense(ADJ,"real, verdadeiro, legítimo, de verdade",1,[],[sense_example1],sourcelist=sourcelist1, usage_note='''atualmente ainda ocorre em alguns compostos''',equivalent=equivalent)
	...
	sense3=Sense(ADV,"muito",3,[],[sense_example2],sourcelist3.fromstring("Coudreau, 466; Studart, 28; Stradelli, 364; Baena, 110"),equivalent=Equivalent("reté",1,4))
	...
	return Entry(lemma,None,[ite],[sense1,sense2,sense3],[histreg1],et)
